                        ...
                        <form action="proses_edit.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="rumpun" id="">
                                    ...
                                    <option <?php echo $data['rumpun']=='IPA' ? 'selected' : '' ?> value="IPA">Komputer</option>
                                    <option <?php echo $data['rumpun']=='IPS' ? 'selected' : '' ?> value="IPS">Akuntansi</option>
                                    <option <?php echo $data['rumpun']=='Bahasa' ? 'selected' : '' ?> value="Bahasa">Manajemen</option>
                                    <option <?php echo $data['rumpun']=='Bahasa' ? 'selected' : '' ?> value="Bahasa">Bahasa Asing</option>
                                </select>
                            </div>
                            <div class="mb-3">
